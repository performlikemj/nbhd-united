...
from .constants import MODEL_RATES, SUBSCRIPTION_PRICE
...
class TransparencyServiceTest(TestCase):
    ...
    def test_transparency_fields(self):
        ...
        self.assertEqual(data["subscription_price"], SUBSCRIPTION_PRICE)
    ...
    def test_transparency_margin_calc(self):
        ...
        self.assertAlmostEqual(
            ...
            SUBSCRIPTION_PRICE - data["your_actual_cost"],
            places=2,
        )
    ...
    def test_transparency_no_usage(self):
        ...
        self.assertEqual(data["platform_margin"], SUBSCRIPTION_PRICE)
