...
LESSONS = [
    ...
    (
        0,
        "Ship small, ship often. A rough version shipped teaches more than a perfect one planned.",
        "Noticed after the Q1 launch — everything I actually shipped was an early, imperfect cut.",
        ["shipping", "creative", "momentum"],
        "reflection",
        "Weekly review 2026-03-14",
    ),
    (
        0,
        "Taste is built by looking, not by thinking about looking.",
        "",
        ["creative", "craft"],
        "conversation",
        "Chat Mar 22",
    ...
    (
        0,
        "The first 45 minutes of the day decide the whole day. Guard them.",
    ...
    (
        0,
        "Constraints are the medium. Remove them and the work goes soft.",
        "",
        ["creative", "craft"],
        "article",
    ...
    (
        0,
        "Quantity breeds quality. Make ten bad ones to find one great one.",
        "",
        ["creative", "practice"],
        "experience",
        "Studio Mar 08",
    ...
    (
        1,
        "People don't need advice — they need to feel seen. Ask one more question before answering.",
    ...
    (
        1,
        "Saying I miss you out loud, soon, matters more than saying it well later.",
        "",
    ...
    (
        1,
        "Repair is cheap if done fast. Expensive if you let it age.",
        "",
    ...
    (
        1,
        "Show up for the small things. Big gestures can't make up for not being there on Tuesdays.",
        "",
    ...
    (
        2,
        "Sleep is not a variable. Everything downstream collapses when it slips below 7.",
    ...
    (
        2,
        "Walk before thinking hard. Movement unlocks what the desk can't.",
        "",
        ["movement", "thinking"],
        "experience",
        "Morning walks",
    ...
    (
        2,
        "Caffeine after 2pm steals tomorrow to pay for today.",
        "",
        ["sleep", "caffeine"],
        "experience",
        "Feb experiment",
    ...
    (
        2,
        "Protein at breakfast buys a steadier afternoon.",
        "",
        ["food", "energy"],
        "article",
        "Huberman — energy stability",
    ),
    # Leadership
    (
        3,
        "Hire for how they disagree, not how they agree.",
    ...
    (
        3,
        "Clarity is kindness. Vague feedback is cowardice in a nice outfit.",
        "",
        ["leadership", "feedback"],
        "conversation",
        "Coaching session",
    ...
    (
        3,
        "The thing you're avoiding saying is usually the thing worth saying first.",
        "",
        ["leadership", "honesty"],
        "experience",
        "Mar 05",
    ...
    (
        3,
        "Context beats instructions. Give the why, trust the how.",
        "",
    ...
    (
        4,
        "Calendar is the budget that actually matters. Money just tells you what happened yesterday.",
        "",
        ["time", "money"],
        "journal",
        "Monthly review",
    ...
    (
        4,
        "Say no to things you'd say yes to at 10pm on Tuesday.",
    ...
    (
        4,
        "Cheap tools are expensive. Pay for the thing you'll touch 500 times this year.",
        "",
        ["money", "tools"],
        "experience",
        "Jan",
    ...
    (
        4,
        "Boring money, interesting life. Reverse the ratio and you suffer.",
        "",
        ["money"],
        "article",
    ...
    (
        5,
        "I don't have a motivation problem. I have a clarity problem in a motivation costume.",
    ...
    (
        5,
        "The version of me that shows up at 6am is not the same person who wrote the plan at 11pm.",
        "",
        ["self", "planning"],
        "journal",
        "Daily Mar 12",
    ...
    (
        5,
        "When in doubt, choose the harder conversation. Softness now, hardness later.",
        "",
        ["self", "honesty"],
        "experience",
        "Feb 19",
    ...
    (
        5,
        "I regret what I didn't try more than what I tried and failed. Every single time.",
        "",
        ["self", "risk"],
        "reflection",
        "Birthday reflection",
