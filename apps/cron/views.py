...
def debug_gateway_tool_proxy(request):
    ...
    Returns the raw gateway response (or error). Re-added for OC 5.28 smoke test
    after the 5.7 verification (PR #740 removed via PR #743). Remove again once
    smoke test confirms the cron-management.md shape still works on 5.28.
