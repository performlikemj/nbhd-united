...
_EVENING_CHECKIN_PROMPT = (
    ...
    "2. Review today's conversations for things the user learned. "
    "If you find notable lessons or insights, suggest them via `nbhd_lesson_suggest`.\n"
    "3. Fill in the 'evening-check-in' section of today's daily note "
    ...
    "4. Send the user exactly ONE message via `nbhd_send_to_user`. Keep it short and casual:\n"
