...
_MORNING_BRIEFING_PROMPT_TEMPLATE = (
    ...
    "Then end that SAME message with a journal deep-link marker as its very last line — "
    "on its OWN line, after a blank line, with nothing (not even a space) after it. "
