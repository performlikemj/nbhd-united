"""Re-run the public-schema RLS lockdown after the service-email opt-out fields.

``tenants.0123_user_service_email_opt_out`` adds two columns to the ``users``
table. Per the recurring topo-shift hazard
(``0066``/``0073``/``0078``/``0080``/``0083``/``0097``/``0098``/``0099``/``0106``/
``0111``/``0114``/``0116``/``0117``/``0119``/``0122``), adding migrations can
re-sort a PRIOR relock earlier in the graph, leaving some owned public table
with ``rowsecurity = false`` at migration time —
...
class Migration(migrations.Migration):
    dependencies = [
        ("tenants", "0123_user_service_email_opt_out"),
    ]
