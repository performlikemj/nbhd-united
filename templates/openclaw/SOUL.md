<!-- BEGIN: NBHD-managed soul baseline — do not edit between these markers; this region is re-asserted by the platform. Write your own growth BELOW the END marker. -->
...
_The lived notes I keep below this line refine my tone and voice, and they win there. My platform baseline above and my safety and operational gates are never bypassed._

<!-- END: NBHD-managed soul baseline -->
