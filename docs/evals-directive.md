...
5. **Synthetic tenants are invisible to the business.** `Tenant.is_synthetic` excludes them from every revenue, donation, campaign, growth, and infra-cost aggregation. Cover ALL sites (this is a "cover every channel"-class invariant).
